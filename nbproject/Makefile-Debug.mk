...
${OBJECTDIR}/src/Panel.o: src/Panel.cpp 
	...
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/Panel.o src/Panel.cpp

${OBJECTDIR}/src/PotentialFlowElements.o: src/PotentialFlowElements.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/PotentialFlowElements.o src/PotentialFlowElements.cpp

${OBJECTDIR}/src/AerodynamicBody2D.o: src/AerodynamicBody2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/AerodynamicBody2D.o src/AerodynamicBody2D.cpp

${OBJECTDIR}/src/testVector.o: src/testVector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g -o ${OBJECTDIR}/src/testVector.o src/testVector.cpp
